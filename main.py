...
BOOKING_BOARD_ID = os.getenv("BOOKING_BOARD_NUMBER",1906910627)
...
OUTPUT_FILE_NAME = os.getenv("OUTPUT_FILE_NAME","bookings_ps_df_2024")
OUTPUT_FILE_NAME_LAST_UPDATE = os.getenv("OUTPUT_FILE_NAME","bookings_ps_items_last_update_stored_2024")
